...
This resets the vector search capability but preserves the SQL database and source corpus.
"""
...
def clear_vector_db():
    ...
    targets = [
        # ChromaDB Directory
        {'path': vectordb_path / 'chroma', 'type': 'dir', 'desc': 'ChromaDB Persistence Directory'},
        
        # FAISS Index
        {'path': vectordb_path / 'ultrarag_faiss.index', 'type': 'file', 'desc': 'FAISS Index File'},
        {'path': vectordb_path / 'faiss_index.bin', 'type': 'file', 'desc': 'Legacy FAISS Index File'},
        
        # BM25 Cache
        {'path': vectordb_path / 'ultrarag_bm25.pkl', 'type': 'file', 'desc': 'BM25 Cache File'},
        {'path': vectordb_path / 'bm25_index.pkl', 'type': 'file', 'desc': 'Legacy BM25 Cache File'},
    ]
