...
print("="*70)
print("STUDENT DATABASE SETUP (SQL Builder)")
print("="*70 + "\n")
...
try:
    ...
    # 'Company Placed' index if exists
    if 'company placed' in [c.lower() for c in columns]:
         cursor.execute("CREATE INDEX IF NOT EXISTS idx_company ON students(\"COMPANY PLACED\")")
         print("✓ Index on COMPANY PLACED")
