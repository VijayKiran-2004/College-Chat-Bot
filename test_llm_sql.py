...
def test_llm_sql():
    ...
    # If 'average' is not in regex logic, the regex path will just filter by gender 'Male' and return ALL male students.
    # Then the summary generator (in query_students) calculates average.
    # So actually `average cgpa` WORKS with regex path because `query_students` computes summary stats!
    ...
    # We want to verified LLM fallback.
