...
class SimpleRAGResponder:
    ...
    def respond(self, query: str, documents: Optional[List[Dict]] = None) -> Optional[str]:
        ...
        if 'chairman' in query_lower:
            return f"The Chairman of TKRCET is {self.kb['personnel']['chairman']}."
        
        if 'founder' in query_lower:
            return f"The Founder of TKRCET is {self.kb['personnel']['founder']} (Founder Chairman of TKR Educational Society)."
        
        if 'vice principal' in query_lower or 'vice-principal' in query_lower:
            return f"The Vice Principal is {self.kb['personnel']['vice_principal']}."
        
        if 'dean' in query_lower:
            return f"The Dean of Academics is {self.kb['personnel']['dean_academics']}."
