class LinkManager:
    ...
    TOPIC_LINKS = {
        ...
        "cse": {
            ...
            "url": "https://tkrcet.ac.in/computer-science-engineering/",
        },
        "ece": {
            "title": "ECE Department",
            "url": "https://tkrcet.ac.in/electronics-communication-engineering/",
        },
        "eee": {
            "title": "EEE Department",
            "url": "https://tkrcet.ac.in/electrical-electronics-engineering/",
        },
        "it": {
            "title": "IT Department",
        ...
        "aiml": {
            "title": "CSE-AIML Dept",
            "url": "https://tkrcet.ac.in/cse-artificial-intelligence-machine-learning/",
        },
        "hostel": {
            "title": "Campus Life",
        ...
        "results": {
            "title": "Student Login Portal (Results & Fee)",
            "url": "https://www.tkrcetautonomous.org/StudentLogin/MainStud.aspx",
        },
        "sem fee": {
            "title": "Student Login Portal (Results & Fee)",
            "url": "https://www.tkrcetautonomous.org/StudentLogin/MainStud.aspx",
    ...
    def extract_relevant_links(self, docs, query=""):
        ...
        for doc in docs[:5]:
            ...
            if link_url and link_url not in seen_urls and link_url.startswith("http"):
                ...
                # For document links, we don't always have a title,
